...
import { fetchListing, fetchListingReservationPreferences } from 'state/concepts/listings/actions';
...
describe('ReservationPreferences useContainer hook', () => {
  let result = null;
  ...
  describe('getInitialProps method', () => {
    ...
    it('should dispatches all actions when user is verified and listingId is present', async () => {
      ...
      expect(store.dispatch).toHaveBeenNthCalledWith(
        2,
        fetchListingReservationPreferences(mockedListingId),
      );
    });
