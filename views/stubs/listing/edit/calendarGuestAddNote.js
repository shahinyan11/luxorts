                ...
                <div className="booking-calendar__panel-content">
                  <Form layout="vertical" size="large">
                    ...
                    <div className="d-flex justify-content-space-between mb-4">
                      ...
                      <a href="#" className="main-link" hidden>
                        Add
                      </a>
                    </div>
                    <p className="booking-calendar__note mb-12">This is not shown to guests</p>
                    <Form.Item htmlFor="note" className="mb-24">
                      <Input.TextArea placeholder="Enter note" id="note" />
                    </Form.Item>
                    <div className="d-flex">
                      <Button htmlType="reset" className="main-btn main-btn--tertiary mr-16">
                        Cancel
                      </Button>
                      <Button
                        htmlType="submit"
...
export default CalendarGuestAddNote;
