...
const CalendarGuestAddNoteDone = () => (
                ...
                <div className="booking-calendar__panel-content">
                  <Form layout="vertical" size="large">
                    ...
                    <div className="d-flex justify-content-space-between mb-8">
                      ...
                      <a href="#" className="main-link ml-auto mr-16">
                        Edit
                      </a>
                      <a href="#" className="main-link">
                        Remove
                    ...
                    <p className="booking-calendar__value mb-0">10 am arrival</p>
                  </Form>
                </div>
              </div>
            </div>
...
export default CalendarGuestAddNoteDone;
