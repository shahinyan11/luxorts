...
const AccommodationAddBedsAddAnotherBedDone = () => (
          ...
          <Form layout="vertical" size="large">
            ...
            <div className="new-listing__item mb-24">
              ...
              <div className="new-listing__add mb-24 pb-8">
                ...
                <div className="d-flex">
                  <Form.Item className="mb-16 ant-form-item--edit-number width-364">
                    <Input placeholder="Enter bed title" value="Bunk bed" />
                    <InputNumber
                      min={0}
                      defaultValue={0}
                      controls={{
                ...
                <Button htmlType="button" className="main-link mb-24">
                  Add another bed
                </Button>
                <Button
                  htmlType="button"
              ...
              <div className="new-listing__add mb-24 pb-8">
                ...
                <p className="new-listing__add-info mb-16">0 beds</p>
              </div>
            </div>
            <div className="new-listing__item mb-24">
...
export default AccommodationAddBedsAddAnotherBedDone;
