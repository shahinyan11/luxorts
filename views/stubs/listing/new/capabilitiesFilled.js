      ...
      <section className="new-listing pt-32">
        <div className="new-listing__container mb-32">
          ...
          <Form layout="vertical" size="large">
            <Form.Item>
              <Input placeholder="Enter capability title" value="Amusement park" />
            </Form.Item>
            <Form.Item className="mb-24">
              <Input
                placeholder="Describe capability"
                value="An amusement park is a park that features various attractions, such as rides and games, as well as other events for entertainment purposes."
              />
            </Form.Item>
...
export default CapabilitiesFilled;
