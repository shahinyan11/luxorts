      ...
      <section className="new-listing pt-32">
        <div className="new-listing__container mb-32">
          ...
          <Form layout="vertical" size="large">
            <Form.Item>
              <Input placeholder="Enter amenity title" value="Smart home system" />
            </Form.Item>
            <Form.Item className="mb-24">
              <Input
                placeholder="Describe amenity"
                value="A smart home system allows homeowners to control appliances, thermostats, lights, and other devices remotely using a smartphone or tablet through an internet connection."
              />
            </Form.Item>
...
export default AmenitiesFilled;
