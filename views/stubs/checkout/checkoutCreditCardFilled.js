...
const CheckoutCreditCardFilled = () => (
          ...
          <div className="personal-information__user">
            ...
            <div className="personal-information__item mb-24">
              <Form layout="vertical" size="large">
                ...
                <Form.Item label="Card Number Visa" htmlFor="card-number">
                  <Input value="4218 5600 0008 1456" id="card-number" className="ant-input-visa" />
                </Form.Item>
                <Form.Item label="Card Number Mastercard" htmlFor="card-number-2">
                  <Input
                    value="4218 5600 0008 1456"
                    id="card-number-2"
                    className="ant-input-mastercard"
                  />
                </Form.Item>
...
export default CheckoutCreditCardFilled;
