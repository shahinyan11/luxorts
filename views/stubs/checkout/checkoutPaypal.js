          ...
          <div className="personal-information__user">
            ...
            <div className="personal-information__item mb-24">
              <Form layout="vertical" size="large">
                ...
                <p className="personal-information__text mb-16">Log in to use PayPal.</p>
                <Button htmlType="button" className="main-btn main-btn--card min-width-200 mb-24">
                  <SvgIcon icon="paypal-colored" className="icon-left" />
                  Log in with PayPal
                </Button>
              </Form>
            </div>
