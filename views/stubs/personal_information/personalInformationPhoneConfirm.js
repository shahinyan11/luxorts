...
const PersonalInformationPhoneConfirm = () => (
          ...
          <div className="personal-information__user">
            ...
            <div className="personal-information__item mb-24">
              ...
              <p className="personal-information__descr text-body mb-16">
                Use your right phone number so users and Luxorts can get in touch.
              </p>
              <p className="text-body mb-16">
                We texted your security code to +1 888-586-1606. It may take a minute to arrive.
              </p>
              ...
              <div className="d-flex mb-24">
                ...
                <Button
                  htmlType="button"
                  className="main-btn main-btn--secondary min-width-140 mr-16"
                >
                  Call me instead
                </Button>
              </div>
...
export default PersonalInformationPhoneConfirm;
