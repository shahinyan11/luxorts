...
const PaymentsAndPayoutsAddCard = () => (
  <Modal
    ...
    footer={
      <div className="d-flex justify-content-flex-end w-100">
        <Button htmlType="reset" className="main-btn main-btn--medium main-btn--tertiary mr-16">
          Cancel
        </Button>
        <Button
          htmlType="submit"
...
export default PaymentsAndPayoutsAddCard;
