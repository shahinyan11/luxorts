      ...
      <section className="booking-details">
        <div className="booking-details__container">
          <div className="booking-details__column">
            ...
            <div className="booking-details__info pb-16 mb-16">
              <div className="booking-details__note">
                <p className="booking-details__item mb-8">
                  <span className="booking-details__reason fw-600">Rejected by Host</span>
                  <span className="booking-details__reason">March 9, 2022</span>
                </p>
                <p className="booking-details__value mb-0">
                  <b className="fw-600">Rejection reason: </b>
                  My plans have changed. So I need to reject the booking. Sorry!
                </p>
              </div>
            </div>
            <div className="booking-details__info pb-16 mb-16">
            ...
            <h2 className="booking-details__subtitle mb-24">Host</h2>
            <div className="booking-details__host mb-24">
              <a href="#">
                <Avatar className="ant-avatar--sm mb-8" src="/images/avatar-2.png" />
              </a>
            ...
            <div className="booking-details__info pb-32 mb-32">
              <p className="booking-details__item mb-16">
                ...
                <span className="booking-details__email">
                  <a href="mailto:marvin.mckinney@gmail.com" className="main-text-btn fw-400">
                    marvin.mckinney@gmail.com
                  </a>
                </span>
              </p>
              <p className="booking-details__item mb-0">
            ...
            <h2 className="booking-details__subtitle mb-24">House rules</h2>
            <div className="booking-details__info pb-32 mb-32">
              <ul className="booking-details__rules mb-16">
              ...
              <a href="#" className="main-text-btn d-inline-flex">
                Show more
              </a>
            </div>
...
export default BookingDetailsRejected;
